...
const Card = ({ title, icon, desc, children }: { title: string; desc: string; icon: React.ReactNode; children?: React.ReactNode }) => {
	...
	return (
		...
		>
			...
			<div className="relative z-20">
				...
				<p className="relative z-10 mt-4 text-center text-sm font-bold text-[#e4ecff] opacity-0 transition duration-200 group-hover/canvas-card:-translate-y-2 group-hover/canvas-card:text-white group-hover/canvas-card:opacity-100 dark:text-white">
					{desc}
				</p>
			</div>
		</div>
